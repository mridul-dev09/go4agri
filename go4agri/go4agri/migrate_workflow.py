...
def migrate_database():
    try:
        ...
        required_roles = [
            ("Admin", "admin@go4agri.co.in"),
            ("Accounts", "Finance@go4agri.co.in"),
            ("Initial reviewer", "Review@go4agri.co.in"),
            ("Inspection planner", "planner@go4agri.co.in"),
            ("Auditor", "auditor@go4agri.co.in"),
            ("Technical reviewer", "technical@go4agri.co.in"),
            ("Certifier", "Certification@go4agri.co.in"),
            ("CEO", "ceo@go4agri.co.in")
        ]
